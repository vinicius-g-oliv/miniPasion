...
extension AboutViewModel {
    ...
    static let views = [AboutViewModel(id: 1, name: "Sobre", image:"infoSymbol4x", descricao: "Memo é um jogo que ajuda e exercitar a memória de maneira divertida e lúdica!"),
                        AboutViewModel(id: 2, name: "Entre em Conta", image: "infoSymbol4x", descricao: "")]
